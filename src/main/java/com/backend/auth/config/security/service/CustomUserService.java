...
import com.backend.auth.api.entity.UserProfile;
...
public class CustomUserService {
    ...
    public com.backend.auth.api.entity.User findOrCreateUserByOAuthAttributes(OAuthAttributes attributes) {
    ...
    private com.backend.auth.api.entity.User createUserByOAuthAttributes(OAuthAttributes attributes) {
