package com.backend.ljy.auth.config.security.oauth.enums;
...
import com.backend.ljy.auth.config.security.oauth.service.impl.GoogleOAuthAttributesConverter;
import com.backend.ljy.auth.config.security.oauth.service.impl.KakaoOAuthAttributesConverter;
import com.backend.ljy.auth.config.security.oauth.service.impl.NaverOAuthAttributesConverter;
